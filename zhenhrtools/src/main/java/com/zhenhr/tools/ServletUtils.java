...
public class ServletUtils {
	...
	public static void writeString(String str, HttpServletRequest req,
	...
	public static void mapToJson(Map<String, ?> map, HttpServletRequest req,
			HttpServletResponse res) {
		String jsonStr = JsonUtil.resultObjTojson(map);
		ServletUtils.writeString(jsonStr, req, res);
	}

	public static void listMapToJson(List<?> list, HttpServletRequest req,
			HttpServletResponse res) {
		String jsonStr = JsonUtil.resultObjTojson(list);
		ServletUtils.writeString(jsonStr, req, res);
	}

	public static void strToJson(String dataStr, HttpServletRequest req,
			HttpServletResponse res) {
		String jsonStr = JsonUtil.resultObjAndStrTojson(dataStr);
		ServletUtils.writeString(jsonStr, req, res);
	}

	public static void jsonStrToJson(String dataStr, HttpServletRequest req,
			HttpServletResponse res) {
		String jsonStr = "{\"code\":\"" + TPErrorCodeGeneral.Succeed_Param
				+ "\",\"msg\":\"ok\"";
	...
	public static void toJson(String key, Object value, HttpServletRequest req,
			HttpServletResponse res) {
		String jsonStr = JsonUtil.resultObjTojson(key, value);
		ServletUtils.writeString(jsonStr, req, res);
	}

	public static void toJson(Object value, HttpServletRequest req,
			HttpServletResponse res) {
