...
public class ReflectionUtils {
	...
	public static <X> X invokeGetterMethod(Object obj, String propertyName) {
		String getterMethodName = "get" + StringUtils.capitalize(propertyName);
		return (X) invokeMethod(obj, getterMethodName, new Class[] {},
				new Object[] {});
	}
...
//			logger.error("不可能抛出的异常:{}", e);
	...
	public static List<String> getFieldsName(final Object obj,
		...
		for (Class<?> superClass = obj.getClass(); superClass != Object.class; superClass = superClass
			...
			Field[] fileds = superClass.getDeclaredFields();
			for (int i = 0; i < fileds.length; i++) {
				Class<?> fieldCls = fileds[i].getType();
				if (fieldCls == cls) {
					fstrList.add(fileds[i].getName());
				}
