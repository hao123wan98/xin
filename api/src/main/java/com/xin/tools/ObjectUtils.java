...
public class ObjectUtils {
	...
	public static <T> void mergeDifferClassValue(T origin, T destination) {
		...
		mergeDifferClassValueSuper(origin, destination, destination.getClass().getSuperclass());

	}

	public static <T> void mergeDifferClassValueSuper(T origin, T destination, Class<?> parentClass) {
